...
public class AmLeasingContract extends TableImpl<AmLeasingContractRecord> {
     ...
     */
    public final TableField<AmLeasingContractRecord, UShort> ID_CONTRACT_NUMBER = createField(DSL.name("ID_contract_number"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");

    /**
     * The column <code>allmob.am_leasing_contract.ID_vehicle</code>.
     */
    public final TableField<AmLeasingContractRecord, UShort> ID_VEHICLE = createField(DSL.name("ID_vehicle"), SQLDataType.SMALLINTUNSIGNED.nullable(false), this, "");
     ...
     */
    public final TableField<AmLeasingContractRecord, UShort> ID_USER_CHANGE = createField(DSL.name("ID_user_change"), SQLDataType.SMALLINTUNSIGNED.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.SMALLINTUNSIGNED)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super UShort, ? super UShort, ? super BigDecimal, ? super LocalDateTime, ? super UShort, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super UShort, ? super UShort, ? super BigDecimal, ? super LocalDateTime, ? super UShort, ? extends U> from) {
