...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory object) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     * Fetch a unique record that has <code>installed_rank = value</code>
     */
    public Optional<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchOptionalByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Byte lowerInclusive, Byte upperInclusive) {
     ...
     */
    public List<com.allane.mobility.persistence.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Byte... values) {
