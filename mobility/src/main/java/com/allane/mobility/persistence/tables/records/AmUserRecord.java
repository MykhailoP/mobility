...
public class AmUserRecord extends UpdatableRecordImpl<AmUserRecord> implements Record6<UShort, String, String, String, LocalDateTime, UShort> {
     ...
     */
    public void setIdUser(UShort value) {
        set(0, value);
    }
    ...
    @Override
    public Row6<UShort, String, String, String, LocalDateTime, UShort> valuesRow() {
    ...
    @Override
    public AmUserRecord value1(UShort value) {
        setIdUser(value);
        return this;
    }
    ...
    @Override
    public AmUserRecord value6(UShort value) {
        setIdUserChange(value);
        return this;
    }

    @Override
    public AmUserRecord values(UShort value1, String value2, String value3, String value4, LocalDateTime value5, UShort value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AmUserRecord(UShort idUser, String name, String surname, String email, LocalDateTime changed, UShort idUserChange) {
        super(AmUser.AM_USER);
